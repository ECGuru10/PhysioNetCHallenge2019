...
function [auroc, auprc, accuracy, f_measure, normalized_observed_utility,observed_utility]=compute_scores_2019_cell(labels,predictions,probabilities)
...
for k=1:length(labels)
    ...
    cohort_labels{k}        = labels{k};
    cohort_predictions{k}   = predictions{k};
    cohort_probabilities{k} = probabilities{k};
end
...
observed_utility=unnormalized_observed_utility;
